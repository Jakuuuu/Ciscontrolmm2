...
export default function About() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      {/* Premium Hero */}
      <section className="relative pt-32 md:pt-40 pb-20 md:pb-32 overflow-hidden border-b border-slate-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            >
              ...
              <div className="flex items-center gap-6">
                <div className="flex flex-col">
                  <span className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">20+</span>
                ...
                <div className="flex flex-col">
                  <span className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">100%</span>
            ...
            <motion.div
              ...
              className="relative p-2 bg-gradient-to-br from-primary/10 to-transparent shadow-2xl bg-white"
            >
              <img
                src={workspaceImg}
                ...
                loading="lazy"
              />
              <div className="absolute -bottom-6 md:-bottom-10 -left-6 md:-left-10 w-24 md:w-40 h-24 md:h-40 border border-slate-200 -z-10 bg-slate-100"></div>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              whileHover={{ y: -5 }}
              className="p-8 md:p-12 bg-white shadow-lg border border-slate-200 relative group"
            >
            ...
            >
              <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity hidden sm:block">
                <Eye size={120} className="text-primary" />
              </div>
              <span className="text-[10px] font-bold tracking-[0.4em] uppercase text-primary mb-4 block">Destino</span>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6 uppercase tracking-tighter">Visión</h2>
              <p className="text-slate-600 leading-relaxed text-base md:text-lg border-l-2 border-primary pl-6 md:pl-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {values.map((v, idx) => (
              <motion.div
                ...
                className="p-8 md:p-10 bg-slate-50 border border-slate-200 hover:bg-white hover:shadow-xl transition-all group"
              >
